...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  def(
    'assassins_mark',
    "Assassin's Mark",
    'Execute a player using the Assassin ability.',
    'Silver',
    'Crosshair',
    'Title'
  ),
  def(
    'overseer_hunter',
    "Overseer's End",
    'Kill the Overseer as the Assassin.',
    'Gold',
    'Crosshair',
    'Title'
  ),
  ...
  def(
    'clean_sweep',
    'Clean Sweep',
    'Win a game without a single State directive.',
    'Silver',
    'Sparkles',
    'Gameplay'
  ),
  def(
    'long_game',
    'War of Attrition',
    'Survive a game that reaches round 12.',
    'Bronze',
    'Clock',
    'Gameplay'
  ),
  def(
    'landslide',
    'Landslide',
    'Win an election where every player votes Aye.',
    'Bronze',
    'CheckCircle',
    'Gameplay'
  ),

        ...
        >
          ...
          >
            ...
            <div className="p-[3vh] space-y-[2vh] overflow-hidden flex flex-col">
              ...
              {postMatchResult && (
                <div className={cn(
                  'rounded-2xl border p-4 shrink-0',
                  postMatchResult.won
              ...
              <button
                onClick={onOpenLog}
                className="w-full py-[1vh] bg-card text-tertiary border border-default rounded-xl hover:bg-hover hover:text-primary transition-all font-mono text-responsive-xs uppercase tracking-widest flex items-center justify-center gap-2 shrink-0"
              >

        ...
        >
          ...
          <div className="px-8 py-6 border-b border-subtle flex items-center justify-between bg-white/5 shrink-0">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="font-thematic text-xl lg:text-2xl uppercase tracking-[0.2em] text-primary">Match Replay</h2>
                <p className="text-[10px] font-mono text-muted uppercase tracking-widest">Post-Match Reconstruction</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {showTruth ? "Hide Deceptions" : "Reveal The Truth"}
              </button>
          ...
          {!currentRound ? (
            <div className="flex-1 flex flex-col items-center justify-center text-muted gap-4">
              ...
              <p className="font-mono text-xs uppercase tracking-widest">No history recorded for this match</p>
            </div>
          ) : (
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-10 min-h-0">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-5 space-y-8">
                  <section>
                    <h3 className="text-[10px] font-mono text-faint uppercase tracking-[0.3em] mb-4">Round {currentRound.round} Government</h3>
                    <div className="space-y-3">
                      <div className="flex items-center gap-4 bg-surface/40 p-4 rounded-2xl border border-subtle">
                        ...
                        <div className="min-w-0">
                          <p className="text-[10px] font-mono text-faint uppercase font-bold tracking-widest mb-0.5">President</p>
                      ...
                      <div className="flex items-center gap-4 bg-surface/40 p-4 rounded-2xl border border-subtle">
                        ...
                        <div className="min-w-0">
                          <p className="text-[10px] font-mono text-faint uppercase font-bold tracking-widest mb-0.5">Chancellor</p>
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-[10px] font-mono text-faint uppercase tracking-[0.3em]">Session Summary</h3>
                      {currentRound.chaos && (
                        <span className="px-2 py-0.5 rounded bg-orange-500/10 border border-orange-500/30 text-orange-400 text-[8px] font-mono uppercase tracking-widest">Chaos Forced</span>
                      )}
                    </div>
                    <div className={cn(
                      ...
                      {currentRound.failed ? (
                        <>
                          <p className="text-2xl font-thematic uppercase tracking-wider mb-2">Government Rejected</p>
                          <p className="text-xs font-mono opacity-60">
                            {currentRound.failReason === 'veto' ? 'Both parties agreed to exercise veto power.' : 'The Assembly failed to confirm this coalition.'}
                          </p>
                        </>
                      ) : (
                        <>
                          <p className="text-[10px] font-mono uppercase tracking-[0.2em] opacity-60 mb-2">Directive Enacted</p>
                          <p className="text-3xl lg:text-4xl font-thematic uppercase tracking-[0.1em]">{currentRound.policy}</p>
                          {currentRound.executiveAction && (
                            <div className="mt-4 pt-4 border-t border-white/5">
                              <p className="text-[9px] font-mono text-orange-400 uppercase tracking-widest flex items-center justify-center gap-2">
                                ...
                                Power Triggered: {currentRound.executiveAction}
                              </p>
                            </div>
                          )}
                        </>
                ...
                <div className="lg:col-span-7 space-y-8">
                  ...
                  {!currentRound.failed && (currentRound.presDeclaration || currentRound.chanDeclaration) && (
                    <section>
                      <h3 className="text-[10px] font-mono text-faint uppercase tracking-[0.3em] mb-4">Legislative Hand</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {/* President's Hand */}
                        <div className="bg-elevated/30 rounded-3xl border border-default p-5 space-y-4">
                          <div className="flex items-center justify-between">
                            <span className="text-[9px] font-mono text-faint uppercase font-bold">President's Deck</span>
                            {showTruth && currentRound.presDeclaration && (
                              (() => {
                                const lied = currentRound.presDeclaration.civ !== (currentRound.presDeclaration.drewCiv ?? 0);
                                return lied && <span className="text-[8px] px-1.5 py-0.5 rounded bg-red-500/20 text-red-400 uppercase font-bold">Deception Detected</span>;
                              })()
                            )}
                          </div>
                          ...
                          <div className="flex flex-col gap-4">
                            <div className="space-y-2">
                              <p className="text-[8px] font-mono uppercase tracking-widest text-ghost">Actual Draw</p>
                              <div className="flex gap-1.5 grayscale opacity-40">
                                {showTruth && currentRound.presDeclaration ? (
                                  ...
                                  <div className="w-10 h-8 rounded border border-dashed border-default flex items-center justify-center text-[8px] text-faint">HIDDEN</div>
                                )}
                              </div>
                            </div>
                            
                            <div className="space-y-2">
                              <p className="text-[8px] font-mono uppercase tracking-widest text-ghost">Public Claim</p>
                        ...
                        <div className="bg-elevated/30 rounded-3xl border border-default p-5 space-y-4">
                           <div className="flex items-center justify-between">
                            <span className="text-[9px] font-mono text-faint uppercase font-bold">Chancellor's Hand</span>
                            {showTruth && currentRound.chanDeclaration && currentRound.presDeclaration && (
                                ...
                                <span className="text-[8px] px-1.5 py-0.5 rounded bg-red-500/20 text-red-400 uppercase font-bold">Conflicting Stories</span>
                            )}
                          </div>

                          <div className="flex flex-col gap-4">
                            <div className="space-y-2">
                                <p className="text-[8px] font-mono uppercase tracking-widest text-ghost">Actual Received</p>
                                <div className="flex gap-1.5 grayscale opacity-40">
                                  {showTruth && currentRound.presDeclaration ? (
                                    <>
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-[10px] font-mono text-faint uppercase tracking-[0.3em]">Voting Records</h3>
                      <div className="flex gap-4">
                         <div className="flex items-center gap-1.5 text-[8px] font-mono text-emerald-400 uppercase tracking-widest">
                           <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" /> Aye
                         </div>
                         <div className="flex items-center gap-1.5 text-[8px] font-mono text-red-500 uppercase tracking-widest">
                           <div className="w-1.5 h-1.5 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]" /> Nay
                         </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {currentRound.votes.length === 0 ? (
                        <div className="col-span-full py-4 text-center text-ghost italic text-[10px]">No vote held this round</div>
                      ) : (
          ...
          <div className="p-6 border-t border-subtle bg-white/5 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-4 text-muted">
              ...
              <p className="text-[10px] font-mono uppercase tracking-widest max-w-xs leading-relaxed">
                Replay uses decrypted archival data. Use the timeline above to navigate through match milestones.
              </p>
            </div>
